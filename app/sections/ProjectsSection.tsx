...
export default function ProjectsSection() {
  ...
  const titleReveal = useSpring({
    ...
    transform: hasBeenInView ? 'translateX(0px)' : 'translateX(50px)',
  ...
  const subtitleReveal = useSpring({
    opacity: hasBeenInView ? 1 : 0,
    transform: hasBeenInView ? 'translateX(0px)' : 'translateX(30px)',
                      ...
                      <div className="space-y-5 pt-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-5 gap-3">
                          {project.stages.map((stage, sidx) => (
                            ...
                            >
                              <span className="font-mono text-xs md:text-sm font-bold tracking-[0.1em]" style={{ color: ACCENT }}>
                                {stage.code}
                              </span>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full mt-8">
                        {project.dualImages.map((img, i) => (
                          <div key={i} className="flex flex-col gap-4">
                            <span className="font-mono text-[11px] tracking-[0.2em] font-medium uppercase" style={{ color: ACCENT }}>
                              {img.label}
                            </span>
